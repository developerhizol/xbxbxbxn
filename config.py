...
CONFIG_URL = "https://tinyurl.com/4d868knn"

APP_DOMAIN = "https://streamnetvpn.bothost.tech"

# Единая точка входа для подписки
SUBSCRIBE_URL = f"{APP_DOMAIN}/sub"

# Прямые ссылки на файлы с конфигами (рабочая и нерабочая подписка)
WORKING_CONFIG_URL = f"{APP_DOMAIN}/sub"
EXPIRED_CONFIG_URL = f"{APP_DOMAIN}/unworksub"
